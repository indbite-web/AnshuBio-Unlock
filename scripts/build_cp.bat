...
setlocal
echo ==========================================================
echo Building Native AnshuBio Credential Provider DLL...
echo Architecture: C++17 / Windows SDK / COM / ICredentialProvider
...
cmake --build . --config Release --target AnshuBioCredentialProvider AnshuBioSessionMonitor
if %ERRORLEVEL% EQU 0 (
    echo.
    echo ==========================================================
    echo [SUCCESS] AnshuBioCredentialProvider.dll built successfully!
    echo Binary: %~dp0..\build\bin\AnshuBioCredentialProvider.dll
    echo ==========================================================
) else (
    echo.
